        ...
        <div class="cardholder">
            ...
            <div class="col">
                <div class="card" style="width: 16rem;">
                    <?php echo '<div class="caption"><img src="data:image/jpeg;base64,'.base64_encode($row['courseImage']).'"/></div>'; ?>
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $row['courseName']; ?></h5>
                        <p class="card-text"><?php echo $row['courseDesc']; ?></p>
                        <?php if ($viewCourse == true): ?>
                            <button type="submit" class="btn btn-info" name="viewCourse">View Course</button>
                        <?php else: ?>
                            <button type="submit" class="btn btn-primary" name="buyCourse">Buy</button>
                        <?php endif; ?> 
                    </div>
                </div>           
            </div>
